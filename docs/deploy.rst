...
Digite no terminal ::
    ...
    (local) ssh dokku@<your.ip.address> config:set <app-name> AWS_STORAGE_BUCKET_NAME=atrader AWS_ACCESS_KEY_ID=AKIAJPDJ4B2OITUTU56A AWS_SECRET_ACCESS_KEY=Jxqhb7t63ZsI2E8v9lHk3kfKrq+EAVvP7JSowfje
